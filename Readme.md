...
# Parsing Script – Smart Badge - Rev. B

This **Parsing** script is designed for the **Smart Badge** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – Smart Badge Rev. B

Este script de **Parsing** está diseñado para el modelo **Smart Badge** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
